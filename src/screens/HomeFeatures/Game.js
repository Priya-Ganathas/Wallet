...
const onSelectSwitch = (value) => {
    ...
    <SafeAreaView>
       ...
       <TouchableOpacity
        ...
        <Text style={{ color: COLORS.darkLime, fontWeight: 'bold', ...FONTS.h1, marginLeft: SIZES.padding * 6.3, marginTop: SIZES.padding * -1, marginBottom: SIZES.padding*1}}> Games </Text>
            ...
            >
                <Text style={{color: COLORS.white, ...FONTS.pop2}} >   Upcoming Games </Text>
